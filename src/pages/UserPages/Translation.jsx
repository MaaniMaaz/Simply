    ...
    <div className="flex min-h-screen">
      ...
      <div className={`flex-1 w-full ${isSidebarCollapsed ? 'md:ml-20' : 'md:ml-64'} transition-all duration-300`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
          ...
          <div className="bg-[#FF5341] w-72 text-white rounded-lg p-3 mb-6 flex items-center">
            ...
            <div className="bg-[#FFFAF3] rounded-xl p-6">
              ...
              <div className="mt-4">
                <div className="relative mt-4">
                  ...
                  <textarea
        value={showTranslation ? outputText : ''}
        readOnly
        className="w-full h-64 p-4 border rounded-lg bg-white mb-4"
        placeholder="Translate something to see the results"
      />
